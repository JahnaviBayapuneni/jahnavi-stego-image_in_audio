function [ ] = embed_process( key, input_wav_file, input_image_file, output_wav_file)
...
%is embedded into one byte of the audio.
    ...
    % read wav data
    [wav_header, wav_len, wav_data] = wav_read(input_wav_file);
    ...
    wav_write(wav_header, wav_len, emb_wav_data, output_wav_file);
end
